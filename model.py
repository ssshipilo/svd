...
if __name__ == "__main__":
    ...
    input_path          = os.path.join(os.getcwd(), "source", "test_image.png)")
    ...
    decoding_t          = 14 # Количество кадров, декодируемых за один раз! Это съедает больше всего VRAM. При необходимости уменьшите.
    device              = "cuda" # or 'cpu'
